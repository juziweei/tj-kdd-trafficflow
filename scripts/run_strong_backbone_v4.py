...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run strong backbone v4")
    parser.add_argument(
        "--config",
        type=Path,
        default=PROJECT_ROOT / "configs" / "strong_backbone_v4_anchor.json",
...
def train_with_adaptive_fusion(
    ...
    horizon_windows: int,
) -> tuple[BaselineBranchBundle, GBDTBundle, FusionBundle, dict[str, object]]:
